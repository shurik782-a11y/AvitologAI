...
4) Заголовок (КРИТИЧНО): ровно две части — «{search_query} {conversion_offer}».
   ...
   - conversion_offer = короткое преимущество (2–5 слов): «с доставкой», «натуральная кожа», «от 3000 ₽» — одно, не всё сразу.
   - Итоговый title обычно 25–55 символов. Пример: «Мужская обувь из кожи с доставкой».
   - ЗАПРЕЩЕНО: простыня ключей, lowercase-каша, дубли «зимняя и летняя…3000-7000…купить онлайн…».
